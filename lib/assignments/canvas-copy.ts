...
export function canvasAssignmentDescriptionHtml(
  ...
  return [
    ...
    `<p>Sign up on the course site if you do not have an account yet with the same Northeastern email you use on Canvas, then Sign in to save your GitHub and Vercel URLs. This site is not Canvas and accounts are not pre-provisioned. Using your Canvas email lets us map site progress back to the roster. Submit your GitHub repository and Vercel URL here in Canvas.</p>`,
  ].join("");
}
