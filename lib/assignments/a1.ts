...
export const A1_RUBRIC: AssignmentRubric = {
  ...
  groups: [
    ...
    },
    {
      ...
      intro:
        "Same nested list as book §1.3.12: one item per Lab 1 section (HeadingTags, ParagraphTag, …), with a/b/c for the Lab component, On your own, and With AI extra, walking 1.3.1–1.3.11 in reading order.",
