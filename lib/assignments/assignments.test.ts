...
describe("assignment catalog", () => {
  it("lists A1–A6 from the syllabus and marks A1/A2 ready", () => {
    ...
    assert.equal(getAssignment("a1")?.dueDate, "2026-09-27");
    assert.equal(getAssignment("a2")?.dueDate, "2026-10-11");
    assert.equal(getAssignment("a3")?.dueDate, "2026-10-25");
    assert.equal(getAssignment("a4")?.dueDate, "2026-11-15");
    assert.equal(getAssignment("a5")?.dueDate, "2026-11-29");
    assert.equal(getAssignment("a6")?.dueDate, "2026-12-13");
    ...
    assert.equal(getAssignment("a5")?.assignedDate, "2026-11-15");
    assert.equal(getAssignment("a6")?.assignedDate, "2026-11-29");
