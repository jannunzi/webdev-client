    ...
    <div className="px-3 py-6 sm:px-5 lg:px-6">
      <div className="mx-auto w-full max-w-[1600px]">
        ...
        <p className="max-w-3xl">
          Classroom version of the book, grouped by chapter and topic — the
          same spine as the course book, not Canvas lecture folders. Open a
          deck to present slides on a wide stage. Keyboard: Left/Right or
