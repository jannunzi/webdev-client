...
export const holidayMeetingNote =
  "University holidays — including Labor Day, Indigenous Peoples’ Day, Veterans Day, and fall break (November 25–29; classes resume November 30) — do not skip a lecture week. If a holiday falls on your meeting day, that section meets online so the chapter sequence stays on track.";
