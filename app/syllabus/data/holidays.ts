 ...
 * Recordings, not Piazza Resources. Shared across all sections. Do not
 * invent a hosting URL.
 */
export const lectureRecordingNote =
  "All lectures are recorded and available to enrolled students. Find them in your Canvas course under Zoom Meetings → Recordings tab — not under Piazza Resources. Missing a lecture for a legitimate reason is fine — use the recording. Recordings are not a general replacement for attending live lectures.";
