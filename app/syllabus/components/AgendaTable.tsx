  ...
  return (
    <SyllabusSection id="agenda" title="Agenda">
      <p>
        ...
        weeks. The midterm (X1) is the week of Oct 26; X2 and the final
        project are the week of Dec 14, even though the last day of classes
        is Dec 13. Quizzes are taken at the end of lecture at the end of
        each chapter.
      </p>
