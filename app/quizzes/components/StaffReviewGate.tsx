...
import ClerkAuthBar from "./ClerkAuthBar";
import StatusPanel from "./StatusPanel";

/**
 * Staff gate for author-review banks. Must not wrap `/quizzes/take`.
 * Signed-out visitors get a sign-in prompt; non-staff get 403 and no answers.
 */
export default async function StaffReviewGate({
  children,
}: {
  children: ReactNode;
}) {
        ...
        <article className="mx-auto max-w-3xl font-sans">
          <StatusPanel title="403 Forbidden" tone="warn">
            <p>
              ...
              Signed-in browsing of the book, syllabus, labs, and practice
              pages is fine. The question bank was not loaded.
            </p>
            <p>
              Students take the graded exam at{" "}
