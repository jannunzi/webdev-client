  ...
  return (
    <Section id="sec-6-2" title="6.2 Programming with a MongoDB Database">
      ...
      >
        ...
        <CodeBlock language="shell">{`cd web-dev-server
...
mongoose.connect(CONNECTION_STRING);`}</CodeBlock>
        ...
        <WithAI
          prompt={`In web-dev-server/.env.example, keep DATABASE_CONNECTION_STRING as the PDF name and mention MONGO_CONNECTION_STRING as an alias. Do not put a real Atlas password in any committed file.`}
        >
      ...
      >
        ...
        <CodeBlock
          language="js"
          name="userSchema"
          file="web-dev-server/Kambaz/Users/schema.js"
        >{`import mongoose from "mongoose";
...
export default userSchema;`}</CodeBlock>
      ...
      >
        ...
        <CodeBlock
          language="js"
          name="UserModel"
          file="web-dev-server/Kambaz/Users/model.js"
        >{`import mongoose from "mongoose";
