      ...
      >
        ...
        >
          <CodeBlock
            language="js"
            name="courseSchema"
            file="web-dev-server/Kambaz/Courses/schema.js"
...
export default courseSchema;`}</CodeBlock>
          <CodeBlock
            language="js"
            name="CourseModel"
            file="web-dev-server/Kambaz/Courses/model.js"
          >{`import mongoose from "mongoose";
...
export default model;`}</CodeBlock>
        ...
        >
          <CodeBlock
            language="js"
            name="createCourse"
            file="web-dev-server/Kambaz/Courses/dao.js"
      ...
      >
        ...
        >
          <CodeBlock
            language="js"
            name="moduleSchema"
            file="web-dev-server/Kambaz/Modules/schema.js"
          >{`import mongoose from "mongoose";
...
export default schema;`}</CodeBlock>
        ...
        >
          <CodeBlock
            ...
            file="web-dev-server/Kambaz/Modules/dao.js"
      ...
      >
        ...
        >
          <CodeBlock
            ...
            file="web-dev-server/Kambaz/Enrollments/schema.js"
          >{`import mongoose from "mongoose";
...
export default enrollmentSchema;`}</CodeBlock>
        ...
        >
          ...
          <CodeBlock
            ...
            file="web-dev-server/Kambaz/Enrollments/dao.js"
