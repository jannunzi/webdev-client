...
export default function Delivery() {
  return (
    <Section id="sec-5-10" title="5.10 Delivery">
      <p>
        Submit this chapter&apos;s work as a new branch on the same{" "}
        <code>kambaz-next-js</code>{" "}repository and deployment from earlier
        chapters, so graders can compare <ChapterLink to={4} />&apos;s
        client-state screens against this chapter&apos;s HTTP APIs side
        by side.
      </p>
      <ol>
        <li>
...
git push -u origin a5`}</CodeBlock>
      <ol start={3}>
        ...
        <li>
          ...
          <code>a5</code>{" "}branch) and the Vercel deployment URL for that
