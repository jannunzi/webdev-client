    ...
    >
      ...
      <div className="space-y-3 p-4 font-sans text-[0.95rem]">
        ...
        <p className="m-0 text-neutral-800">
          {quiz.count} questions drawn at random. Open the dedicated practice
          page to start the self-check, see explanations, and try another
          draw. Scores stay on this device only.
        </p>
        <Link
